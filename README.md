...
🗂️ Database Structure : 
 ...
 Movies – Stores movie details such as name, genre, duration, and language

Theatres & Screens – Manages cinema locations and screen information

Shows – Handles movie show timings and screen allocation

Seats – Maintains seat availability and booking status

Customers – Stores customer information

Bookings / Tickets – Records ticket booking details including seats, show, and pricing

Relationships are implemented using primary keys and foreign keys to maintain referential integrity.
